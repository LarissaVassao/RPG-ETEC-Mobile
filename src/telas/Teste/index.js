...
import { View, StyleSheet, Image, Text, TextInput, StatusBar, TouchableOpacity, ScrollView, Modal, Alert, Button} from 'react-native';
...
export default function Teste({ navigation }) {
  ...
  const handleButtonPress = (color) => {
    ...
    <View style={styles.container}>
        <StatusBar backgroundColor="#1E3A53" barStyle="dark-content" />      
            <TouchableOpacity 
...
<View style={styles.mainContent}>
        ...
        <View style={styles.resourceRow}>
          ...
          <View style={styles.resourceControl}>
            ...
            <TouchableOpacity 
              ...
              onPress={() => handleResourceEdit('vida')}
            >
              <Text style={styles.resourceInputText}>
                {resources.vida}
              </Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.resourceButton}>
        ...
        <View style={styles.resourceRow}>
          ...
          <View style={styles.resourceControl}>
            ...
            <TouchableOpacity 
              style={styles.resourceInputTouchable}
              onPress={() => handleResourceEdit('mental')}
            >
              <Text style={styles.resourceInputText}>
                {resources.mental}
              </Text>
        ...
        <View style={styles.resourceRow}>
          ...
          <View style={styles.resourceControl}>
            ...
            <TouchableOpacity 
              style={styles.resourceInputTouchable}
              onPress={() => handleResourceEdit('energia')}
            >
              <Text style={styles.resourceInputText}>
                {resources.energia}
              </Text>
